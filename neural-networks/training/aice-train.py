...
use_lincombs_for_validation_errors = True
...
for seed in random_seeds:
    ...
    for var in variables:
        ...
        mid = keras.layers.Dense(90, activation='relu')(inputs)
        ...
        if train_nn:
            ...
            result = model.fit(x_train, y_train[:,idx], validation_data=xy_val,
    ...
    if 4 in shown_figures:
        ...
        if fit_mol:
            ...
            for var in shown_species:
                ...
                color = colors[var]
                zorder = 2. if var != 'other' else 3.
                ax.scatter(y_[:,si+i], Y_[:,si+i], color=color, alpha=alpha,
            ...
            for var in shown_species:
                ...
                ax.scatter(y_[:,si+i], error_i, color=color,
